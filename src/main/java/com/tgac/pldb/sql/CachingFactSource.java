 ...
 */
public final class CachingFactSource implements AnswerSource {
	...
	private CachingFactSource(AnswerSource delegate) {
		this.delegate = delegate;
	}

	public static CachingFactSource over(AnswerSource delegate) {
